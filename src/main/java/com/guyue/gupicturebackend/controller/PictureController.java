...
import com.guyue.gupicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.guyue.gupicturebackend.api.imagesearch.baidu.ImageSearchApiFacade;
import com.guyue.gupicturebackend.api.imagesearch.baidu.model.ImageSearchResult;
import com.guyue.gupicturebackend.api.imagesearch.so.SoImageSearchApiFacade;
import com.guyue.gupicturebackend.api.imagesearch.so.model.SoImageSearchResult;
import com.guyue.gupicturebackend.common.BaseResponse;
import com.guyue.gupicturebackend.common.DeleteRequest;
...
import com.guyue.gupicturebackend.model.enums.PictureReviewStatusEnum;
import com.guyue.gupicturebackend.model.vo.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<Integer> uploadPictureByBatch(
            @RequestBody PictureUploadByBatchRequest pictureUploadRequest,
            HttpServletRequest request) {
        ThrowUtils.throwIf(pictureUploadRequest == null, ErrorCode.PARAMS_ERROR);
        User loginUser = userService.getLoginUser(request);
        int uploadCount = pictureService.uploadPictureByBatch(pictureUploadRequest, loginUser);
...
//        String redisKey = "gupicture:listPictureVOByPage:" + hashKey;
        String cacheKey = "gupicture:listPictureVOByPage:" + hashKey;
        // 1.从本地缓存中查询 （Caffeine）
